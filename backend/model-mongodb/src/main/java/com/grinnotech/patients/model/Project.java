 ...
 */
@Document
@Model(value = "Patients.model.Project", createMethod = "projectService.update", readMethod = "projectService.read", updateMethod = "projectService.update", destroyMethod = "projectService.destroy", paging = true, identifier = "uuid")
